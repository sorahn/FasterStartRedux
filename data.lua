...
local mod_graphics = "__FasterStartRedux__/graphics"
...
data:extend({ {
    ...
    icon = mod_graphics .. "/icons/fusion-construction-robot.png",
    icon_size = 64,
    icon_mipmaps = 4,
    ...
    icon = mod_graphics .. "/icons/mini-power-armor.png",
    icon_size = 64,
    icon_mipmaps = 4,
    subgroup = "armor",
    ...
    name = "mini-fusion-reactor-equipment",
    sprite = {
        filename = mod_graphics .. "/equipment/mini-fusion-reactor-equipment.png",
        width = 128,
        height = 128,
        priority = "medium",
        scale = 0.5
